...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: tQR5ls8FROY/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: bFxwzUBrIgo/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: k88WY3JwaQV/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__gjWv)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__vBE)}
                role={"img"}
              />
            ),
